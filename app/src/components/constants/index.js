...
export const VENDINGMACHINE_ABI = [
  {
    "inputs": [
      {
        "internalType": "contract IZCDToken",
        "name": "zcdTokenAddress",
        "type": "address"
      }
    ],
  ...
  },
  {
    "inputs": [
      {
        "internalType": "enum VendingMachine.Soda",
        "name": "soda",
        "type": "uint8"
      }
    ],
...
export const ZCDTOKEN_ADDRESS="0x7f0Ed920Ed6b5bd1fBFd5Ab6b46DE777997468A5";

export const ZCDTOKEN_ABI = [
    {
      "inputs": [],
      "stateMutability": "nonpayable",
      "type": "constructor"
